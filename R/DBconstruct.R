...
DBconstruct <- function(ftp, species, short, write = F, ...){
        ...
        tidy_db <- function(x){
                ...
                data.frame(refID = RefID, geneID = geneids, proteinID = proids, Family_name = fam, Sub_family_name = sub_fam, goIDs = goID, annotation = annos, goType = type, goTerms = goTerm, Pathway = pathways, stringsAsFactors = F)
